  ...
  template: `
    <div class="cart-modal-container" 
      ...
      <div class="cart-modal"
        ...
        <button class="go-to-cart btn cursor" (click)="goToCart()">장바구니 보러가기 <span class="icon"></span></button>
        <button class="ok btn cursor" (click)="close()">확인</button>
        <button aria-label="close cursor" class="close icon" (click)="close()"></button>
      </div>
    </div>
  `,
